const $ = (id) => document.getElementById(id);
    ...
    $("verifyButton").onclick = () => {
      verified = true;
      $("loginError").textContent = "Email disahkan! Anda boleh daftar.";
    };
    ...
    $("authForm").onsubmit = (e) => {
      ...
      if (authMode === "signup") {
        ...
        if (!verified) {
          $("loginError").textContent = "Please press SEND VERIFICATION LINK first.";
          return;
        }
        if (pass !== confirm) {
        ...
        localStorage.setItem("user_profile_" + user, JSON.stringify({ username:user, email, password: pass }));
